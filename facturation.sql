...
CREATE TABLE IF NOT EXISTS prestation (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    type TEXT CHECK (
        type IN ('formation', 'consultation')
    ) NOT NULL,
...
INSERT
    OR IGNORE INTO utilisateur (nom, email, mot_de_passe)
VALUES (
        'Admin',
        'admin@example.com',
        'password123'
...
VALUES (
    ...
    (
        ...
        'Société XYZ',
        'Marie Martin',
        'marie.martin@xyz.com'
    ),
    (
        'Pierre Durand',
        'Startup Innov',
        'Pierre Durand',
        'pierre.durand@innov.com'
    );

-- Insertion de quelques prestations de test
INSERT
    OR IGNORE INTO prestation (
        type,
        date,
        heure_debut,
        heure_fin,
